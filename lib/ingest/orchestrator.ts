...
console.log("!!! LOADING ORCHESTRATOR DEBUG VERSION !!!");
...
export async function upsertEvent(
  ...
  console.log(`Upserting event: ${event.title} (existingId: ${existingId})`);
  ...
  if (existingId) {
    ...
    // Download image and calculate size first
    ...
    console.log('DEBUG UPDATE EXISTING - PARAMS LEN', params.length);
